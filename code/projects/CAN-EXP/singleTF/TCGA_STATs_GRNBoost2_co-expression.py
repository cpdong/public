...
canList=['ACC','CHOL','BLCA','BRCA','CESC','COADREAD','COAD','UCEC','ESCA','GBM','HNSC','KICH','KIRC','KIRP','DLBC',
'LIHC','LGG','GBMLGG','LUAD','LUSC','SKCM','MESO','UVM','OV','PAAD','PCPG','PRAD','READ','SARC','STAD','TGCT','THYM','THCA','UCS']
...
for canType in canList:
    ...
    cols = [c for c in df.columns if c[13:15] == '01']
    df=df[cols]
