...
d4<- read.csv("https://raw.githubusercontent.com/cpdong/public/master/data/CAN-EXP/ChIPBaseV2_regNet_tcga.csv", row.names=1, header=T, stringsAsFactors=F)

d5<- d3[which(d3$entrez_ID %in% intersect(rownames(d4), d3$entrez_ID)), ]
