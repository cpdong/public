...
#GEOlist<- GEOlist[which(GEOlist$platform=="GPL96"),]
#GPL96_list<- as.character(GEOlist[,1])

#for(m in 1:length(GPL96_list)){
    #############################################################
#    GSE_ID= GPL96_list[m]
#    platform= "GPL96"

#    dir="/home/cpdong/Desktop/regulonActivity/GPL96/"
    #############################################################
#    source("https://raw.githubusercontent.com/cpdong/public/master/code/projects/CAN-EXP/GPL96_regulons_activity_all_in_ONE.R")
#}
#
#
#
...
index<- which((d1[,1]=="1-Mar")|(d1[,1]=="2-Mar"))[c(2,4)]
d1<- d1[-index,]
